...
- **`readme.txt` compatibility and length limits.** `Tested up to` raised to 7.0.3 (the version the integration matrix now exercises); the short description trimmed to the supported 150 characters; the 2.0.0 upgrade notice trimmed to the supported 300.
